...
public class FastQualityControlTest extends AbstractTestcase {
	...
	@Test
	public void testAlleleFrequencyCheckWithWrongPopulation() throws IOException {
		String configFolder = "test-data/configs/hapmap-chr1";
		String inputFolder = "test-data/data/single";
	...
	@Test
	public void testAlleleFrequencyCheckWithNoSamplesForPopulation() throws IOException {
